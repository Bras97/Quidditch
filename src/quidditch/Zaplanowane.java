 ...
 * @author Elater
 */
public class Zaplanowane extends javax.swing.JFrame {
     ...
     */
    public Zaplanowane() throws SQLException {
        initComponents();
        fillData();
        setVisible(true);
 ...
 /*                   Collections.sort(listaSedziow, new Comparator<Sedzia>() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Zaplanowane.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                try {
                    new Zaplanowane().setVisible(true);
